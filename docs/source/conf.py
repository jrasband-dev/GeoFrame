...
# key site root paths
static_assets_root = ""
github_root = "https://github.com/jrasband-dev/geoframe"
web_root = "https://jrasband-dev.github.io/geoframe/"
...
def linkcode_resolve(domain: str, info: dict[str, Any]) -> str | None:
    ...
    project_root = (conf_dir_path.parent.parent / "geoframe").absolute()
